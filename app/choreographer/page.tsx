...
export default function ChoreographerPage() {
  ...
  return (
    <div className="bg-black text-white min-h-screen choreographer-page">
      <Header 
        onChoreographerToggle={toggleChoreographer}
        onWorkshopToggle={toggleWorkshop}
        onExperiencesToggle={toggleExperiences}
        alwaysVisible={true}
      />
      ...
      <div className="pt-20 md:pt-32 px-4 md:px-6 lg:pl-24">
         <div className="text-lg md:text-xl font-bold mb-8">
            ...
            className={`transition-all duration-300 cursor-pointer touch-target ${
        ...
        <div className={`transition-all duration-700 ease-in-out ${
          ...
          <div className="w-full gallery-columns">
            {choreographerGalleryItems.map((item, index) => (
              <Link key={index} href={item.href} className="block touch-target">
