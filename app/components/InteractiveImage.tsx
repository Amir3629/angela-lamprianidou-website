      ...
      {isModalOpen && (
        ...
        >
          <div className="relative max-w-7xl max-h-[90vh] w-full">
            <button
              onClick={closeModal}
              className="absolute top-2 right-2 md:top-4 md:right-4 text-white text-xl md:text-2xl hover:text-gray-300 transition-colors z-10 bg-black/50 rounded-full w-8 h-8 md:w-10 md:h-10 flex items-center justify-center"
            >
              ×
            </button>
            <img
