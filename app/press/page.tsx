...
export default function PressPage() {
  ...
  const description = `2008 - 2022 Press about Angela Lamprianidou`;

  const additionalInfo = `2020 Norton portofoilio
/AngelaLamprianidou_Portfolio.pages

Press Expose PDF
/170613_Exposee_ALamprianidou_Web_2.pdf
 ...
 this artistic surrounding and give it more art-s(h)it.`;
  ...
  const renderAdditionalInfo = () => {
    return (
      <div className="space-y-4">
        <div>
          <p className="font-semibold">2020 Norton portofoilio</p>
          <a href="/AngelaLamprianidou_Portfolio.pages" className="text-green-400 hover:text-green-300 underline">Download PDF</a>
        </div>
        
        <div>
          <p className="font-semibold">Press Expose PDF</p>
          <a href="/press_pdf_1.pdf" className="text-green-400 hover:text-green-300 underline">Download PDF</a>
        </div>

        <div className="space-y-2">
          <p className="font-semibold">2008 - 2022 Press about Angela Lamprianidou</p>
          
          <div>
            <p className="font-semibold">Greek press:</p>
            <a href="https://web.archive.org/web/20161026104630/http://int.ert.gr/you-want-to-be-the-person-you-are/" target="_blank" rel="noopener noreferrer" className="text-green-400 hover:text-green-300 underline">www.int.ert.gr</a>
            <br />
            <a href="http://popaganda.gr/i-chorografia-tis-aftosinidisias/" target="_blank" rel="noopener noreferrer" className="text-green-400 hover:text-green-300 underline">www.popaganda.gr</a>
            <br />
            <a href="http://www.ladylike.gr/articles/synentefxeis/h-antzela-lamprianidoy-se-rwtaei-an-thes-na-eisai-o-anthrwpos-poy-eisai.4325972.html" target="_blank" rel="noopener noreferrer" className="text-green-400 hover:text-green-300 underline">www.ladylike.gr</a>
          </div>

          <div>
            <p className="font-semibold">generelly press about my workshops:</p>
            <div className="space-y-1">
              <a href="https://www.berliner-woche.de/schoeneberg/c-kultur/performance-fuer-alle-im-rathaus_a393354" target="_blank" rel="noopener noreferrer" className="text-green-400 hover:text-green-300 underline">berliner-woche.de</a>
              <br />
              <a href="https://www.berlin.de/ba-tempelhof-schoeneberg/aktuelles/pressemitteilungen/2023/pressemitteilung.1288461.php" target="_blank" rel="noopener noreferrer" className="text-green-400 hover:text-green-300 underline">berlin.de</a>
              <br />
              <a href="https://www.berlin.de/ba-tempelhof-schoeneberg/aktuelles/pressemitteilungen/2022/pressemitteilung.1246150.php" target="_blank" rel="noopener noreferrer" className="text-green-400 hover:text-green-300 underline">berlin.de</a>
              <br />
              <a href="https://leute.tagesspiegel.de/tempelhof-schoeneberg/tipp/2022/10/04/242340/" target="_blank" rel="noopener noreferrer" className="text-green-400 hover:text-green-300 underline">tagesspiegel.de</a>
            </div>
            <a href="http://www.debop.gr/deBlog/interviews/thelo-na-endido-stin-pisti-oti-oi-anthropoi-boroun-na-allaksoun-mia-synedefksi-me-tin-adzela-labrianidou" target="_blank" rel="noopener noreferrer" className="text-green-400 hover:text-green-300 underline">www.debop.gr</a>
            <br />
            <a href="https://web.archive.org/web/20200804232014/https://e-pieria.gr/news-2/culturenews/10263-soma-kai-dimiourgia" target="_blank" rel="noopener noreferrer" className="text-green-400 hover:text-green-300 underline">www.e-pieria.gr</a>
            <br />
            <a href="http://www.olympospress.gr/ξύπνημα-των-αισθήσεων-το-workshop-χορεύω-όπω/" target="_blank" rel="noopener noreferrer" className="text-green-400 hover:text-green-300 underline">www.olympospress.gr</a>
            <br />
            <a href="https://web.archive.org/web/20211019084227/http://www.ballhausost.de/produktionen/appointment-on-stage/" target="_blank" rel="noopener noreferrer" className="text-green-400 hover:text-green-300 underline">www.ballhausost.de</a>
          </div>

          <div>
            <Link href="/Per4mer/tanzhintanzher" className="text-green-400 hover:text-green-300 underline font-semibold">Tanz hin Tanz her</Link>
            <br />
            <a href="https://web.archive.org/web/20210508133512/https://www.freitag.de/autoren/jamal-tuschick/integration-auf-augenhoehe/view" target="_blank" rel="noopener noreferrer" className="text-green-400 hover:text-green-300 underline">Jamal Tuschick from derFreitag:</a>
          ...
          <div>
            ...
            <a href="/press_pdf_10.pdf" className="text-green-400 hover:text-green-300 underline">Download PDF</a>
            <br />
            <a href="https://web.archive.org/web/20180308081030/http://kink.cz/angela-lamprianidou/" target="_blank" rel="noopener noreferrer" className="text-green-400 hover:text-green-300 underline">Appointment, www.kink.cz/angela-lamprianidou/</a>
          </div>

          <div>
            <Link href="/Per4mer/alihop" className="text-green-400 hover:text-green-300 underline font-semibold">Alihop</Link>
            <br />
            <a href="https://web.archive.org/web/20110619123353/http://ms.stubnitz.com/content/volle-kraft-spektakel-angela-lamprianidou-alihop-0" target="_blank" rel="noopener noreferrer" className="text-green-400 hover:text-green-300 underline">Paul Rose:</a>
          ...
          <div>
            <Link href="/Per4mer/SITz" className="text-green-400 hover:text-green-300 underline font-semibold">SITz</Link>
            ...
            <p><a href="http://www.rozhlas.cz/radiowave/waveculture/_zprava/nejeden-tanecni-vecer-tela-v-ohrozeni-a-sitz--1020869" target="_blank" rel="noopener noreferrer" className="text-green-400 hover:text-green-300 underline">Veronika Stefanova, radio Wave www.rozhlas.cz</a></p>
            ...
            <p><a href="http://www.tanecnizona.cz/index.php?option=com_content&task=view&id=484&Itemid=42" target="_blank" rel="noopener noreferrer" className="text-green-400 hover:text-green-300 underline">Markéta Faustová, Dance Zone, 23. 2. 2012 www.tanecnizona.cz</a></p>
            <p><a href="http://www.ceskatelevize.cz/ivysilani/1148499747-sama-doma/212562220600014/obsah/187555-pozvanka-do-divadla-ponec-mga-daniela-rehakova-a-jana-vrana/" target="_blank" rel="noopener noreferrer" className="text-green-400 hover:text-green-300 underline">Interwiev on chez TV</a></p>
          </div>
          ...
          <div>
            ...
            <p><a href="https://web.archive.org/web/20100807235148/http://thehiddenpeople.com/articlesarticulos/sitz/" target="_blank" rel="noopener noreferrer" className="text-green-400 hover:text-green-300 underline">Sara Blaylock from thehiddenpeople.com:</a></p>
            ...
            <p><a href="/press_pdf_11.pdf" className="text-green-400 hover:text-green-300 underline">Emma Haro:</a></p>
          ...
          <div>
            <Link href="/Per4mer/tongue" className="text-green-400 hover:text-green-300 underline font-semibold">Tongue</Link>
          ...
          <div>
            <Link href="/Per4mer/backtoemotion" className="text-green-400 hover:text-green-300 underline font-semibold">Back To Emotions (es)</Link>
            <p>Barcelona</p>
            <a href="http://www.tea-tron.com/quimpujol/blog/2009/02/17/back-to-emotion-angela-lamprianidou-1622009-la-casa-de-a-lamprianidou/" target="_blank" rel="noopener noreferrer" className="text-green-400 hover:text-green-300 underline">www.tea-tron.com</a>
            ...
            <a href="http://www.fuga.es/2009/02/17/que-fluya-el-deseo-que-corra-la-sangre-el-performer-en-zapatillas/" target="_blank" rel="noopener noreferrer" className="text-green-400 hover:text-green-300 underline">www.fuga.es</a>
            <br />
            <a href="https://lamprianidou.com/backtoemo/timeoutbackto.pdf" target="_blank" rel="noopener noreferrer" className="text-green-400 hover:text-green-300 underline">time out magazin barcelona 27.2-3.3.09</a>
            <br />
            <a href="http://nosolojazz.contrabanda.org/2008/11/" target="_blank" rel="noopener noreferrer" className="text-green-400 hover:text-green-300 underline">Interview on radio contrabanda with Antonio Narváez</a>
          </div>

          <div>
            <Link href="/Per4mer/sit" className="text-green-400 hover:text-green-300 underline font-semibold">Sit</Link>
          ...
          <div>
            <Link href="/archive/el-cuerpo-del-otro" className="text-green-400 hover:text-green-300 underline font-semibold">El cuerpo del otro</Link>
            <p>Barcelona</p>
          ...
          <div>
            <Link href="/archive/shortcuts" className="text-green-400 hover:text-green-300 underline font-semibold">Short cuts</Link>
            <p>Bremen Schwankhalle</p>
            <p>Carlos Murias: A perplex performance before its perplexities</p>
          </div>

          <div>
            <Link href="/archive/katharsi" className="text-green-400 hover:text-green-300 underline font-semibold">Katharsi</Link>
          ...
          <div>
            <Link href="/archive/loop" className="text-green-400 hover:text-green-300 underline font-semibold">Loop</Link>
          ...
          <div>
            <Link href="/archive/time" className="text-green-400 hover:text-green-300 underline font-semibold">Time</Link>
          ...
          <div>
            <Link href="/archive/art-sit" className="text-green-400 hover:text-green-300 underline font-semibold">Art Sit</Link>
  ...
  return (
    <MediaGallery
      ...
      title={
            <a
              href="https://lamprianidou.com/Per4mer/portfo/AngelaLamprianidou_Portfolio-final-bw-2.pdf"
                        target="_blank"
