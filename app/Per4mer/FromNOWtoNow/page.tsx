...
export default function FromNOWtoNowPage() {
  const fromNOWtoNowMedia = [
    {
      src: "/22.11.10(4)-1.jpg",
      alt: "From NOW to Now",
      type: "image" as const,
  ...
  const description = `It begins in the pause —
...
`;
  ...
  const additionalInfo = `It can take many forms:
