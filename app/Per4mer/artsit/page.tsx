...
export default function ArtSitPage() {
  const artsitMedia = [
    ...
    {
      src: "https://vimeo.com/manage/videos/1124725779",
      alt: "Art Sit Video",
      type: "video" as const,
      title: "Art Sit Video"
    }
  ...
  const description = `The first feeling of

happiness is to shit !

Generally on the
0 near the 0, you let things go.
...
Location: Gossen Hallen, Erlangen, @ Arena Festivall 2000
...
We were nearly 20 different artists, musicians, painters, photographers, etc. So I started to design my part... a very intimae part, that everybody visits every day...
