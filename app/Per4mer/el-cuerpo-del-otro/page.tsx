  ...
  const elCuerpoMedia = [
    {
      ...
      alt: "El cuerpo del otro performance video",
      type: "video" as const,
      title: "El cuerpo del otro Performance Video"
    },
    {
      src: "https://www.youtube.com/watch?v=geZwW0VAWSw",
      alt: "El cuerpo del otro YouTube Video",
      type: "video" as const,
      title: "El cuerpo del otro YouTube Video"
    },
    {
      src: "/elcuerpo_1.jpg",
