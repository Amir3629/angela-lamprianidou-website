...
export default function LoopPage() {
  const loopMedia = [
    {
      src: "https://www.youtube.com/watch?v=S-GMgp4NbtI",
      alt: "Loop Performance Video",
      type: "video" as const,
      title: "Loop Performance Video"
    },
    {
      src: "/loop01.jpg",
      alt: "Loop performance 1",
      type: "image" as const,
      title: "Loop Performance"
    },
    {
      src: "/loop02.jpg",
      alt: "Loop performance 2",
      type: "image" as const,
      title: "Loop Performance"
    },
    {
      src: "/loop03.jpg",
      alt: "Loop performance 3",
      type: "image" as const,
      title: "Loop Performance"
    },
    {
      src: "/gallery/loop.jpg",
      alt: "Loop performance 4",
      type: "image" as const,
      title: "Loop Performance"
    }
  ];
...
Loop pictures the vibrating gravity that surrounds us. The speed of contemporary life is transforming bodies into shaking spasmatic movements, as heard in Janis Christu's music, as to be seen in A.Lamprianidou's performance.`;
  ...
  const additionalInfo = `We are in the 21st century and theatre has to become reality and not fiction. I wish that Loop, as it is created in a very plastic character and works as a picture due to her reiteration will penetrate with the critique it contains to the observer.
