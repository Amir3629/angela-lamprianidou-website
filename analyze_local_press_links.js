// Complete script to analyze ALL links on LOCAL press page
// Run this in browser console on http://localhost:3002/press

console.log("=== COMPLETE LINK ANALYSIS - LOCAL PRESS PAGE ===");
...
console.log(`\n✅ ANALYSIS COMPLETE!`);
console.log(`Copy this output to compare with live version.`);